...
func TestEngineQueue_Finalize(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		l1F.ExpectClearReceiptsCacheBefore(refD.Number)
		...
		l1F.ExpectClearReceiptsCacheBefore(refE.Number)
	...
	t.Run("repeat", func(t *testing.T) {
		...
		l1F.ExpectClearReceiptsCacheBefore(refH.Number)
	...
	t.Run("older-data", func(t *testing.T) {
		...
		l1F.ExpectClearReceiptsCacheBefore(refC.Number)
	...
	t.Run("reorg-safe", func(t *testing.T) {
		...
		l1F.ExpectClearReceiptsCacheBefore(refDAlt.Number)
